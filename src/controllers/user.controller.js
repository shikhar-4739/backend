...
const getUserChannelProfile = asyncHandler(async(req, res) => {
    ...
    const channel = await User.aggregate([          // different pipelines
        {
            $match: {                             //   to fetch data of a particular username
                username: username?.toLowerCase()
            }
        },
        {
        ...
        {
            $addFields: {                 // used to add additional field to the object
                subscribersCount: {
                    $size: "$subscribers"               // getting no of subscribers 
                } ,
